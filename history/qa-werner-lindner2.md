---
title: "Питання та відповіді з Вернером Лінднером: Розробка апаратного забезпечення"
---
...
> [!NOTE]
> 
> *Примітка:* Це дещо відрізняється від того що розповідав [Дейв Вудфілд](../peoples/ec-uk/pers_dave-woodfield.md) на зустрічі присвяченій 40-ій річниці комп'ютера.
...
[Наступна сторінка: Апаратні розширення та картриджі](qa-werner-lindner3.md)
