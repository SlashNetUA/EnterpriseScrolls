---
title: "Конверсія ігор з платформи Pico-8: звуки"
---
...
Після чого кожну фазу огинаючої записав у тестову бейсік програму типу такої:
...
Натискаючи на клавіши **1**-**9** можна прослухати відповідну огинаючу.

Коли готові звучання влаштовують, можна їх перенести у код програми, або зберегти огинаючі у окремий файл у вигляді [esc-послідовностей](../system-info/info_esc-sequences.md). А потім завантаживши при старті програми використовувати їх стандартним шляхом (використовуючи процедуру [Sound](../hisoft-pascal/hpu/sound.hpu.md)).
...
Процедура завантаження огинаючих у вигляді [esc-послідовностей](../system-info/info_esc-sequences.md) з файлу у аудіобуфер на мові [HiSoFT Pascal](../hisoft-pascal.md):
```
