...
Через те що друга половина кольорів палітри вибирається через BIAS, то деякі кольори будуть відрізнятись значно сильніше. Ось для прикладу палітра яку можна взяти для початку (в ній є проблема з темнозеленим та деякими сіруватими кольорами, але присутні усі кольори).
