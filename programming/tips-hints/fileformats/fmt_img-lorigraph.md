---
title: "‘ÓÏ‡Ú Ù‡ÈÎÛ ´Lorigraph imageª"
---
# Lorigraph image
...
| ------------ | ------ |:-----------:| -------------------------------------------------------------------------------------------------------- |
| VIDEO_MODE   | 1 byte |      0      | Graphics video mode (See also [IS-Basic manual](../../../manuals/is-basic-man-en/options/man_vo-video-mode.md ))            |
| VIDEO_COLOUR | 1 byte |      1      | Graphics colour mode (See also [IS-Basic manual](../../../manuals/is-basic-man-en/options/man_vo-video-col.md ))            |
