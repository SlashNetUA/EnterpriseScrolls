...
\*) вірно лише для відеосторінок що використовує EXOS. Користувацькі відеорежими задані через [LPT](../system-info/nick/lpt.md) можуть використовувати різні набори шрифтів.
