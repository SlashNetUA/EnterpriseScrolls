---
title: "Трюки та хитрощі: текстові шрифти 8×9 та робота з ними"
---
...
<sup>\*) вірно лише для відеосторінок що використовує EXOS. Користувацькі текстові відеорежими задані через [LPT](../system-info/nick/lpt.md) можуть використовувати різні набори шрифтів.</sup>
