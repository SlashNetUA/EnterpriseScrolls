# Різноманітна інформація по системі

Задля максимальної сумісності з усіма конфігураціями системи при розробці програмного забезпечення в першу чергу необхідно користуватись функціями EXOS, і використовувати власні рішення лише тоді коли їхнього функціоналу буде недостатньо.

[EXOS-сумістність](system-info/exos-compability.md)

## Центральний процесор Zilog Z80

[Опис](http://z80.info/zip/z80cpu_um.pdf)  
[Додаткова інформація](http://z80.info/)

[Опис](http://www.ep128.hu/Sp_Konyv/Z80_sorozat_1.htm) (угорською)
