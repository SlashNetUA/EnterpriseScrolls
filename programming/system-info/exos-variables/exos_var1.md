---
title: EXOS variable 1 - FLAG_SOFT_IRQ
---
# 1 - FLAG_SOFT_IRQ

This is the byte set non-zero by а device to cause a software interrupt. It could also be set by the user to cause a software interupt directly. This variable is also available at a [fixed address](sys-var_flag-soft-irq.md).
