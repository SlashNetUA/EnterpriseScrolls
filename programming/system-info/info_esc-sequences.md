---
title: Керуючі символи та Escape-послідовності
---
...
## Канал [EDITOR](exos-devices/editor.md)
...
## Системне розширення Windows

Розширення дозволяє маніпулювати текстовими відеосторінками як вікнами. Разом з новим відеодрайвером воно використовує наступні керуючі послідовності.

| Символ | HEX | DEC | Опис                                                                                                                                                             |
|:------:|:---:|:---:| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  `^Z`  | 1Ah | 26  | Очистити екран та встановити курсор на початкову позицію.                                                                                                        |
|  `^J`  | 0Ah | 10  | Line-feed. Перемістити курсор донизу на наступний рядок (якщо курсор внизу текстового екрану то здійснюється прокрутка екрану за умови що прокручування активне) |
|  `^M`  | 0Dh | 13  | Carriage return. Повертає курсор на початок поточного рядка.                                                                                                     |
|  `^^`  | 1Eh | 30  | Встановити курсор на початкову позицію (верхній лівий кут).                                                                                                      |
|  `^Y`  | 19h | 25  | Видалити текст до кінця рядка без переміщення курсора.                                                                                                           |
|  `^H`  | 08h |  8  | Перемістити курсор вліво.                                                                                                                                        |
|  `^I`  | 09h |  9  | Перемістити курсор вправо.                                                                                                                                       |
|  `^K`  | 0Bh | 11  | Перемістити курсор догори.                                                                                                                                       |
|  `^V`  | 16h | 22  | Перемістити курсор униз.                                                                                                                                         |
...
## Драйвер миші від BoxSoft

| Символ | HEX | DEC | Опис                                     |
|:------:|:---:|:---:| ---------------------------------------- |
|  `O`   | 4Fh | 79  | Відобразити курсор миші                  |
|  `o`   | 6Fh | 111 | Приховати курсор миші                    |
|  `P`   | 50h | 80  | Отримати поточні координати курсора миші |

Після посилання символу `P` у канал драйвера миші, можна отримати з нього (шляхом читання 4 байт) наступну інформацію:
...
## Читання даних з відеосторінок EXOS
...
> [!Примітка]
> Майте на увазі що при зчитуванні текстових даних з текстового каналу ми отримаємо дані які дещо відрізняються від тих що були записані. При виведенні на екран EXOS робить додаткові перетворення символів:
> 

| SET INK n | PRINT CHR$(x) → | videomem |
|:---------:| --------------- | -------- |
|     1     | 32-127       →  | 32-127   |
|     1     | 128-159     →   | 0-31     |
|           |                 |          |
...
Операційна система [IS-DOS](../../software/ss-is-dos.md) підтримує стандарт терміналу **VT52** з деякими доповненнями.
