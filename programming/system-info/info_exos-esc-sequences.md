...
| `esc i <n>` | 1Bh, 49h, \<n\> | 27, 73, \<n\> | Вибір кольору тексту:<br> n=**0**: зелений на чорному<br> n=**2**: червоний на чорному<br> n=**4**: синій на білому (чорний на зеленому у режимі **Fast Video**)<br> n=**6**: чорний на червоному |
