...
(взято з [інструкції для IS-DOS](../../manuals/is-dos-man/isdos-p3-scr-output.md))
...
| `esc i <n>` | 1Bh, 69h, \<n\> | 27, 105, \<n\> | Вибір кольору тексту:<br> n=**00h**: зелений на чорному<br> n=**02h**: червоний на чорному<br> n=**04h**: синій на білому (чорний на зеленому у режимі **Fast Video**)<br> n=**06h**: чорний на червоному |
...
| `esc x 4` | 1Bh, 78h, 34h | 27, 120, 4 | Вибрати прямокутний курсор ( **█** ) |
| `esc x 5` | 1Bh, 78h, 35h | 27, 120, 5 | Приховати курсор |
| `esc Y <n> <m>` | 1Bh, 59h, \<n\>, \<m\> | 27, 89, \<n\>, \<m\> | Перемістити курсор на рядок **n** і стовпець **m** (верхній лівий кут екрану: **n**=**m**=**20h**) |
| `esc y 4` | 1Bh, 79h, 34h | 27, 121, 4 | Вибрати курсор у вигляді підкреслення ( **\_** ) |
| `esc y 5` | 1Bh, 79h, 35h | 27, 121, 5 | Відобразити курсор |
