...
[Модифікація локалізацій](mods/localization-mod.md)
...
Напівофіційна локалізація створена локальним дистриб'ютером у Данії компанією [Semicap ApS](../companies/semicap-aps.md).
...
Напівофіційна локалізація створена угорською ['a' Studió](../companies/a-studio.md) на замовлення [Enterprise Computers GmbH](../companies/enterprise-computers-gmbh.md) у 1989 році. В ній використовувалась лише додаткова розкладка та шрифти — текст повідомлень не змінений.
