...
На даний час найбільш вживані версії [EXOS](../ss-exos.md) наступні:
...
> *"...EROS — назва, яку розробники обрали, дотримуючись давньої традиції називати операційні системи комп'ютерів на честь персонажів грецької міфології. Але маркетологи Enterprise змусили змінити її на EXOS..."* ([Bruce Tanner](../../peoples/ec-uk/pers_bruce-tanner.md))
...
*...під час увімкнення живлення регістри Nick заповнюються випадковими значеннями, а EXOS 2.0 не встановлює чорну рамку перед тестом оперативної пам'яті. Це означає, що більша частина екрану заповнена випадковим кольором рамки...*
...
Крім виправлення помилок були додані наступні покращення:
  ...
  - нова [системна змінна SPRITE](../../programming/system-info/exos-variables/exos_var38.md) що керує методом накладання цифрових відеоданих з шини розширення на екран.
  - нова [системна змінна RANDOM_IRQ](../../programming/system-info/exos-variables/exos_var39.md).
