...
Програма написана на мові [IS-BASIC](../programming/is-basic/pr-is-basic.md).
Текст програми зберігаються у токенізованому форматі. Але інтерпретатор вміє читати файли і у звичайному текстовому форматі. Ці файли можуть бути завантажені у [IS-BASIC](../programming/is-basic/pr-is-basic.md).
...
Завантажувач компільованої BASIC-програми ([Zzzip](../programming/zzzip/zzzip-compiler.md)). Не плутати з розповсюдженим форматом архіву. Ці файли можуть бути завантажені у [IS-BASIC](../programming/is-basic/pr-is-basic.md). Зазвичай перейменовують на стандартний **.bas**.
