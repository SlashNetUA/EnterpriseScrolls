Стаття з журналу [Enterpress 2017/2-3](../enterpress-2017-03-06.md).
...
The other Pascal compiler available for the Enterprise is an [HiSoft](../../../../companies/hisoft-systems.md)’s product. This program is undeniably undervalued, which is partly understandable, as the compiler only implements the standard Pascal, so its features are behind Turbo Pascal’s ones: the biggest drawback is the lack of a string type.  
...
Procedure `SetVar (ExosVariable: integer; NewValue: integer);` Sets the **ExosVariable** [EXOS variable](../../../../programming/system-info/info_exos-variables.md) to **NewValue**.
...
The [following sections](../2017-07-08/enterpress_2017-n4-hisoft-pascal_en.md) of this article series, will be about the use of VIDEO: pages, graphics, and file management.