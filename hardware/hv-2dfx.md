...
Для графічних даних передбачено 8 мегабайт додаткової пам'яті.
...
<div style="text-align:center;">
<img src="2dfx/2dfx-tvc.jpg" alt="Карта 2dfx для комп'ютера Videoton TVC" width="50%"><br><i>зовнішній вигляд карт для комп'ютерів Enterprise та Videoton TVC</i></div>
