...
<img src="../../companies/pics/bugtronics-ramkort.png" alt="Карта зовнішнього розширення ОЗП вставлена у Mini Motherboard" width="70%"></div>

У цей модуль можна було підключити розширювач з додатковими слотами, що дозволяло підключати до 4 (або 8) карт розширення.

<div style="text-align:center;">
<img src="../../companies/pics/dataquip-electronics-mb.png" alt="Схема підключення з реклами продукту" width="50%"></div>
