...
Хоча Enterprise має [послідовний порт](../connections/pinouts-serial-net.md), він не може одночасно приймати та передавати дані (повний дуплекс), що необхідно для зв'язку через модем. Ця проблема вирішується за допомогою плати послідовного порту/модема, яка містить не лише модем, але й стандартний повнодуплексний послідовний порт.
