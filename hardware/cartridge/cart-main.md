...
<img src="pics/cart_03-07.png" width="45%"><br>*схема оригінальної плати картріджу 03-07* 

Згодом з'явилась її модифікація з підтримкою ПЗП розміром **32** КБ (**27С256**).

[Модифікація стандартного картріджа](mods/cart-03-07-mod.md)

### 2x16K+1x32K cartridge (EP-PLUS) (P/N 09-88)

![](pics/cart_09-88-view.jpg)

Картрідж з трьома слотами для ПЗП був розроблений угорською фірмою ['a' Stúdió](../../companies/a-studio.md) для свого системного розширення [Enterprise Plus](enterprise-plus.md). Один слот (16КБ) був призначений для ПЗП із розширенням, другий (16КБ) для ПЗП з Бейсіком (який потрібно було переставити з оригінального картріджу), а третій (32КБ) - порожній (для користувацьких ПЗП).
