...
<div style="text-align:center;">
<img src="hardware/connections/pics/rgb-scart-cable_01.jpg" alt="RGB-SCART кабель" width="50%"></div>

Через те що майже усі порти мають вигляд звичайних крайових роз'ємів для їх використання потрібні спеціальні кабелі або перехідники. Їх можна як [зробити самотужки](hardware/connections/pinouts-main.md) так і [придбати вже готові](https://enterprise128.hu/hu/online-ep-piacter).  
