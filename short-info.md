...
У стандартну комплектацію до комп'ютера ходить картдрідж з [IS-Basic](programming/is-basic.md). Ця мова програмування сягає далеко за межі мов програмування тогочасних 8-бітних комп'ютерів. Її головні особливості:
...
Одним з недоліків цього інтерпретатора є низька швидкість. У багатьох Basic-бенчмарках відразу було помітно суттєве відставання від Бейсіків на інших платформах, але в той же час точність прорахунків чисел із плаваючою комою була вищою.
