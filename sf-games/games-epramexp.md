...
Ігри для комп'ютера **Enterprise 128** з розширенням оперативної пам'яті.

Частина ігор із цього списку вимагає більше ніж 128 КБ ОЗП для роботи, а частина — використовує додаткову пам'ять для розширеного функціоналу.
