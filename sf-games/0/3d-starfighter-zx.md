...
## Скріншоти
<img src="screens/scrn_3d-starfighter-zx_01.png" width="24%">
<img src="screens/scrn_3d-starfighter-zx_02.png" width="24%">
<img src="screens/scrn_3d-starfighter-zx_03.png" width="24%">
<img src="screens/scrn_3d-starfighter-zx_04.png" width="24%">
...
## Посилання
- [Опис на ep128.hu (угорською)](http://www.ep128.hu/Games/3D-Starfighter.htm)
- [Інформація про оригінальну версію](https://spectrumcomputing.co.uk/entry/9423/ZX-Spectrum/3D_Starfighter)
- [Завантажити](http://www.ep128.hu/Ep_Games/Prg/3D-Starfighter.rar)
...
`1`: почати гру для одного гравця  
`2`: почати гру для двох гравців  
`R`: змінити керування  

### Керування у грі  

 - `Keyboard` (можна перевизначити)  
 - `Internal Joystick` (через меню перевизначення керування як клавіші 6,7,8,9)  
 - `External Joystick 1` (через меню перевизначення керування як External Joy, що одночасно активує `Int Joy`)  
 - `External Joystick 2` (через меню перевизначення керування як клавіші 5,6,7,8,0)  

(через некоректну конверсію гри, при виборі `Ext Joy 1` / `Ext Joy 2`, під час активації щитів проводяться постріли, бо клавіша `Space` також активує клавішу `0`)   

`Fire`: стріляти  

`Space`: активація щитів  
`P`: пауза  
`Q`: вихід з гри у головне меню  

(керування за замовчуванням)  
Перший гравець: `A`, `N`, `I`, `O`, `M`  
Другий гравець: `1`, `2`, `3`, `4`, `5`
