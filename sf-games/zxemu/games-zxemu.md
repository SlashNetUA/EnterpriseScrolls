...
Для емуляції програмного забезпечення з платформи ZX Spectrum 48k можна використовувати наступні емулятори: 
 ...
 - [ZX Emulator](../../hardware/he-zxemu.md) — апаратний емулятор.
...
Даний список містить ігри які можна запустити у програмних емуляторах. Апаратний емулятор здатен запускати значно ширший асортимент ігор ніж представлені на цій сторінці.
