...
- [Завантажити](https://www.ep128.hu/Ep_Games/Prg/DiaTanX.rar)
...
У меню перевизначення клавіш вибрати потрібні клавіші керування а клавішу для паузи швидко натиснути, відпустити і відразу затиснути.  
Ліворуч знизу з'явиться напис **SKIP ON**. Після чого у грі `LShift` буде завантажувати новий рівень.  
Якщо повторити процес перевизначення то чіт буде вимкнено і з'явиться напис **SKIP OFF**.