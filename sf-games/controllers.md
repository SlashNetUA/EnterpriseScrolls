...
На даний час найбільш поширеним є інтерфейс [BoxSoft(Neos) Mouse](../hardware/hid/mouse-boxsoft.md), або його сучасна реалізація [EnterMice](../hardware/hid/mouse-entermice.md).
