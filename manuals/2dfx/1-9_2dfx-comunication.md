...
При портуванні, звісно, слід зважати на різницю у видимій області екрана обох машин, початкову позицію зображення та інтерпретацію кольорів — про це детально йшлося в розділах «[Геометрія](1-6_geometry.md)» та «[Робота з кольором](1-7_color-handling.md)».
