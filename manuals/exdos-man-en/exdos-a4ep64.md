...
If you are using an Enterprise 64 with EXOS version **2.0**, there are two restrictions you will have on the use of EXDOS:
 ...
 - You will not be able to use the "null" filename to load the file "START" from disk (see appendix E). If you press **Fkey 1** (START) from BASIC, EXDOS will think that you are trying to load a file from the RAMDISK.
