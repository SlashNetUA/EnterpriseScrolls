...
Copies data from a file, device or channel to another file, device or channel. [(see more)](../dos-commands/cmd-copy.md)
...
`ECHO [text]`  
Prints text (comments, instructions etc.) in an EXDOS.INI batch file. [(see more)](../dos-commands/cmd-echo.md)
...
Initialises the EXDOS system and runs simple batch files. [(see more)](../dos-commands/cmd-exdos.md)

`FORMAT [d:] [filename] [/1] [/H] [/8]`  
...
Moves files from one directory to another on a disk. [(see more)](../dos-commands/cmd-move.md)

`MVDIR [d:] [path] [/H] [d:] [path]`  
Moves sub-directories from one directory to another on a disk. [(see more)](../dos-commands/cmd-mvdir.md)

`PAUSE [text]`  
Prints a message and prompts the ENTER key to be pressed. [(see more)](../dos-commands/cmd-pause.md)

`RAMDISK [number] [/D]`  
Creates or destroys the RAM disk. [(see more)](../dos-commands/cmd-ramdisk.md)

`REM [characters]`  
Allows comments to be put in EXDOS batch files. [(see more)](../dos-commands/cmd-rem.md)
...
Displays data from a file or an EXOS device or channel. [(see more)](../dos-commands/cmd-type.md)

`VAR number [[number]|[ON]|[OFF]]`  
Displays or sets the value of an EXOS variable. [(see more)](../dos-commands/cmd-var.md)
