...
Insert text starting at line **100**, incrementing line numbers in **10**s; this does a true insert, moving up existing lines as necessary. The default for **n** and **i** is **10**. Line numbers are generated automatically for you, like BASIC's [AUTO](../is-basic-man-en/commands/man_cs-auto.md). Hit **Stop** to get out.
