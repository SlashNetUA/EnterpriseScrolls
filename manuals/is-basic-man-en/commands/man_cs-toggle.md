...
Також за допомогою цієї команди можна змінювати (перемикати) значення [системних змінних](../../../programming/system-info/info_exos-variables.md).

`TOGGLE EXOS-var-number`