...
Can be used in immediate mode. See [DATE$](../functions/man_fn-date.md) function.

----

See also [TIME](man_cs-time.md) ans EXDOS/IS-DOS [DATE](../../dos-commands/cmd-date.md)