...
See [CONTINUE](man_cs-continue.md), [RETRY](man_cs-retry.md), [EXIT HANDLER](man_cs-exit-handler.md), and the functions [EXLINE](../functions/man_fn-exline.md) and [EXTYPE](../functions/man_fn-extype.md).
