...
300 END
```
As you can see, [ORD](functions/man_fn-ord.md) and [CHR$](functions/man_fn-chr.md) are opposites. [ORD](functions/man_fn-ord.md) gives an ASCII code for a character and [CHR$](functions/man_fn-chr.md) will print a character for an ASCII code.
...
Once you have run a program which redefines characters, you can still print those characters until you type [CLEAR FONT](commands/man_cs-clear.md), press the 'reset' button twice in quick succession, or switch off the computer.
