...
An invalid specification for a drive and path was given as a parameter in a [PATH](commands/cmd-path.md) command.
...
A [HELP](commands/cmd-help.md) command was entered, but the corresponding text file (containing a "**HLP**" suffix and residing in the **\HELP** sub-directory) was not found.
